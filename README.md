...
- `chainsaw test --test_pass=<password> --loglevel=DEBUG`: Tests a password against ChainSaw's password cracking algorithm. This is useful for testing the algorithm's accuracy, and for testing password strength.
